            ...
            useJwt
                ...
                .then(res => {
                    if (res.data.error) {
                        ...
                        const data = { ...res.data.user, accessToken: res.data.accessToken, refreshToken: res.data.refreshToken }
                        // TODO: update ability (CASL)
                        ...
                        <Form action='/' className='auth-register-form mt-2' onSubmit={handleSubmit(onSubmit)}>
                            <div className='mb-1'>
                                ...
                                <Controller
                                    ...
                                    control={control}
                                    render={({ field }) => (
                                        <Input autoFocus placeholder='johndoe' invalid={errors.name && true} {...field} />
                                    )}
                                />
